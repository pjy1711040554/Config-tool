<template>
  <a-popover v-model:visible="showPicker" trigger="click" class="ant3-color-picker" :class="[colorSize ? 'ant3-color-picker--' + colorSize : '']" v-bind="$attrs">
    <template #content>
...
<script lang="ts">
  ...
  import {OPTIONS_KEY, type IUseOptions } from './useOptions';
